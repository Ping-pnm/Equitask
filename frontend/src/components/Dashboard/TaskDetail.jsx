...
export default function TaskDetail() {
    return (
        <section id="dashboard-task-detail-view" className="stream-content dashboard-view-detail" style={{ display: 'none', }}>
            {/* Breadcrumbs / Header */}
            <div id="btn-back-to-group" className="breadcrumb-container">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                    strokeLinecap="round" strokeLinejoin="round">
                    <path d="M19 12H5M12 19l-7-7 7-7" />
                </svg>
                <div className="breadcrumb-content">
                    <img src="../public/assets/groupSign.png" alt="Group" className="breadcrumb-logo" />
                    <span className="breadcrumb-text">Group 1 <span className="breadcrumb-separator">&gt;</span> <span
                        id="task-detail-student-name">Name Surname 1</span></span>
                </div>
            </div>
            ...
            <div className="detail-content-grid">
                ...
                <div className="column-main">
                    ...
                    <div className="task-header-row">
                        <img src="../public/assets/taskSign.png" alt="Task" style={{ width: '32px', height: '32px', }} />
                        <span id="task-detail-task-name" className="task-header-title">Task 1</span>
                    ...
                    <div className="ai-section-header">
                        <img src="../public/assets/Ai-sign.png" alt="AI" style={{ width: '24px', height: '24px', }} />
                ...
                {/* Right Sidebar (320px matching previous view) */}
                <div className="column-sidebar">
                    ...
                    <div className="sidebar-card">
                        <div className="ai-section-header">
                            <img src="../public/assets/Ai-sign.png" alt="AI" style={{ width: '18px', height: '18px', }} />
