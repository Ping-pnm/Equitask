...
export default function AddTaskModal({ isOpen, onClose, studentName }) {
            ...
            <div className="modal-content modal-edit-content" style={{ maxWidth: '650px', maxHeight: '90vh', overflowY: 'auto' }}>
                ...
                <div className="modal-title-row">
                    <h2 className="modal-title-text" style={{ color: '#5cc3e0' }}>
                        Add Task : <span id="add-task-student-name">{studentName}</span>
                    </h2>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                        <span onClick={onClose}
                            style={{ fontSize: '16px', color: '#666', cursor: 'pointer', fontWeight: '500' }}>Cancel</span>
                        <button type="submit" onClick={onClose} className="modal-submit-btn"
                    ...
                    <div className="modal-input-wrapper" style={{ padding: '20px' }}>
                        <div
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#000' }}>
                                Rows:
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="black" stroke="white" strokeWidth="2" style={{ cursor: 'pointer' }}>
